    ...
    if (key) {        
        switch (key) {            
            case 'Num':
                ...
                if (sCurValue.indexOf('.') != -1 && sCurValue.length < 21 && (sCurValue.length - sCurValue.indexOf('.')) < 9) {
                    fnInputNum(value);
                }
                break;            
            case 'Point':
    ...
    switch (sMark) {
        ...
        case '+':
            ...
            if (sCurValue.indexOf('(') != -1 | sCurValue.indexOf(')') != -1) {
                nResult = nResult === null ? +sCurValue.replace(/[()]/g, '') : nResult.replace(/[()]/g, '') + (+sCurValue.replace(/[()]/g, ''));
            }
        ...
        case '-':
            ...
            if (sCurValue.indexOf('(') != -1 | sCurValue.indexOf(')') != -1) {
                nResult = nResult === null ? +sCurValue.replace(/[()]/g, '') : nResult - sCurValue.replace(/[()]/g, '');
            }
            nResult = nResult === null ? +sCurValue : nResult - sCurValue;
            break;
        case '*':
